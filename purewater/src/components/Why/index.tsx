...
const WhyUs = () => {
  return (
    <div id="whyus" className="bg-white relative   flex items-center  n justify-center overflow-hidden z-50 ">
            ...
            <div className="flex flex-col items-center justify-between lg:flex-row py-16">
                <div className=" relative ">
                    ...
                    <div className="lg:max-w-xl lg:pr-5 relative z-40">
                        ...
                        We make your life
                        <span className="my-1 inline-block border-b-8 border-g4 bg-white px-4 font-bold text-g4 animate__animated animate__flash">healthier</span>
                        </h2>
