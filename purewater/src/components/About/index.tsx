        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
            <div className="grid grid-cols-1 gap-x-8 gap-y-6 text-base font-semibold leading-7 text-black sm:grid-cols-2 md:flex lg:gap-x-10">
              <a href="#whyus">Why Us <span aria-hidden="true">&rarr;</span></a>
              <a href="#product">Product <span aria-hidden="true">&rarr;</span></a>
              <a href="#testimoni">Testimoni<span aria-hidden="true">&rarr;</span></a>
